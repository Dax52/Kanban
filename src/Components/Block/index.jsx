          ...
          <Switch>
            <Route path="/backlog">
              <section className="list">
                ...
                <div className="list__content">
                  <Task list={TasksSelect(this.state.tasks, 0)} full={true} />
                </div>
              </section>
            </Route>
            <Route path="/ready">
              <section className="list">
                ...
                <div className="list__content">
                  <Task list={TasksSelect(this.state.tasks, 1)} full={true} />
                </div>
              </section>
            </Route>
            <Route path="/inprogress">
              <section className="list">
                ...
                <div className="list__content">
                  <Task list={TasksSelect(this.state.tasks, 2)} full={true} />
                </div>
              </section>
            </Route>
            <Route path="/finished">
              <section className="list">
                ...
                <div className="list__content">
                  <Task list={TasksSelect(this.state.tasks, 3)} full={true} />
                </div>
              </section>
            </Route>
            <Route path="/">
